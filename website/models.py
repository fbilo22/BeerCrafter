...
class Hop:
    def __init__(self, recipe_type, recipe_id, hop_name, quantity, use_type, use_time):
        self.recipe_type = recipe_type
        self.recipe_id = recipe_id
...
class Yeast:
    def __init__(self, recipe_type, recipe_id, yeast_name):
        self.recipe_type = recipe_type
        self.recipe_id = recipe_id
...
class Note:
    def __init__(self, recipe_type, recipe_id, note):
        self.recipe_type = recipe_type
        self.recipe_id = recipe_id
        self.note = note
...
def get_all_recipes():
    ### Fucntion to extract all recipes from the database
